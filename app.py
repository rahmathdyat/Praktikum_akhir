...
st.set_page_config(
    page_title="Prediksi Data Jumlah Kunjungan Wisatawan Mancanegara ke Indonesia Tahun (2008-2025)",
    page_icon="📊",
    layout="wide"
)

# --- Judul Aplikasi Utama ---
st.title("💡 Prediksi Data Jumlah Kunjungan Wisatawan Mancanegara ke Indonesia Tahun (2008-2025)")
st.markdown("---")
...
<div style='text-align: center; font-size: 0.9em; color: gray;'>
    Aplikasi Data Mining Interaktif © 2025. Dibuat dengan Streamlit dan Scikit-learn.
    <br>
